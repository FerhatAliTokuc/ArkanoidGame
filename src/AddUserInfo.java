...
public class AddUserInfo {
	public static void adduserinfo(int score) 
	{
		...
		JOptionPane.showMessageDialog(new MessageDialogInFrame(),"", "GAME OVER", JOptionPane.INFORMATION_MESSAGE, gameovericon); 
		String Name=JOptionPane.showInputDialog(null," Game over ! Please write your name without space:","Game over ! Please write your name without space");
